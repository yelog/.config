...
windows = {
    -- 同一应用的所有窗口自动网格式布局 
    same_application_auto_layout_grid = { prefix = windowHyperKey, key = "Z", message = "" },
    -- 同一应用的所有窗口自动水平均分或垂直均分 
    same_space_auto_layout_grid = { prefix = windowHyperKey, key = "X", message = "" },
    -- 同一工作空间下的所有窗口自动网格式布局
    same_application_auto_layout_horizontal_or_vertical = { prefix = windowHyperKey, key = "R", message = "" },
    -- 同一工作空间下的所有窗口自动水平均分或垂直均分 
    same_space_auto_layout_horizontal_or_vertical = { prefix = windowHyperKey, key = "T", message = "" },
    -- 左半屏
    ...
    -- 居中
    center = {prefix = windowHyperKey, key = "S", message = "Center"},
    -- 等比例放大窗口
    zoom = {prefix = windowHyperKey, key = "=", message = "Zoom Window"},
    -- 等比例缩小窗口
    narrow = {prefix = windowHyperKey, key = "-", message = "Narrow Window"},
    -- 最大化
    max = {prefix = windowHyperKey, key = "F", message = "Max Window"},
    -- 切换到下一个屏幕
    switchNextScreen = {prefix = windowHyperKey, key = "N", message = "Max Window"},
    -- 将窗口移动到上方屏幕
...
applications = {
    ...
    {prefix = applicationHyperKey, key = "W", message="WeChat", bundleId="com.tencent.xinWeChat"},
    ...
    --{prefix = applicationHyperKey, key = "T", message="iTerm2", bundleId="com.googlecode.iterm2"},
    {prefix = applicationHyperKey, key = "T", message="Teams", bundleId="com.microsoft.teams"},
